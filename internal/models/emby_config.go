...
type EmbyConfig struct {
	...
	EnableLibraryPoster     int    `json:"enable_library_poster" gorm:"default:0"`                           // 是否启用媒体库封面自动生成
	LibraryPosterCron       string `json:"library_poster_cron" gorm:"type:varchar(100);default:'0 3 * * *'"` // 封面生成定时任务
